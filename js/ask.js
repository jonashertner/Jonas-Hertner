  ...
  const BOOT = {
    en: {
      desktop: [
        ...
        "No data retained here. OpenAI store=false (exceptions: openai.com/privacy).",
    ...
    de: {
      desktop: [
        ...
        "Keine Daten hier gespeichert. OpenAI store=false (Ausnahmen: openai.com/privacy).",
    ...
    fr: {
      desktop: [
        ...
        "Aucune donnée conservée ici. OpenAI store=false (exceptions: openai.com/privacy).",
